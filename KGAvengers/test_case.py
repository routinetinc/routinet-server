...
class TimeTreeTests(TestCase):
    ...
    def test_timetree_aftertobefore_with_comment(self):
        ...
        # コメントなしtimetreebeforeのテスト(一週間後)
    def test_timetree_before_post(self):
        ...
        now = datetime.now()
        post = now + timedelta(days=6)
        request = {
            "data": {
                'day':post.strftime("%Y%m%dT%H%M%S%z")+'+0000',
                'routine_id':ri[0].id
            }
        }
        ...
        d1 = post - timedelta(days=1)
        d2 = post - timedelta(days=2)
        d3 = post - timedelta(days=3)
        d4 = post - timedelta(days=4)
        d5 = post - timedelta(days=5)
        
        self.assertEqual(res['data']['data']['timetree']['days'],[{'day': post.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d1.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d2.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d3.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d4.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d5.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': now.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': [{'task_finish_id': f'{(ri[0].id-1)*3+3}', 'finish_time': tfw3.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+2}', 'finish_time': tfw2.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+1}', 'finish_time': tfw1.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}]}],'error')

    # コメントありtimetreebeforeのテスト(一週間後)
    def test_timetree_before_with_comment_post(self):
    ...
    # コメントなしtimetreeafterのテスト
    def test_timetree_after_pre(self):
        u = User(
            username          = 'ヤマダ',
            email             = '1',
            age               = 19,
        ...
        request = {
            "data": {
                'day':pre.strftime("%Y%m%dT%H%M%S%z")+'+0000',
                'routine_id':ri[0].id
            }
        }
        ...
        d1 = pre + timedelta(days=1)
        d2 = pre + timedelta(days=2)
        d3 = pre + timedelta(days=3)
        d4 = pre + timedelta(days=4)
        d5 = pre + timedelta(days=5)
        d6 = pre + timedelta(days=6)

        self.assertEqual(res['data']['data']['timetree']['days'],[{'day': now.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': [{'task_finish_id': f'{(ri[0].id-1)*3+3}', 'finish_time': tfw3.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+2}', 'finish_time': tfw2.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+1}', 'finish_time': tfw1.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}]}, {'day': d6.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d5.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d4.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d3.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d2.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d1.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}],'error')

    # コメントありtimetreeafterのテスト
    def test_timetree_after_with_comment_pre(self):
        u = User(
            username          = 'ヤマダ',
            email             = '1',
            age               = 19,
        ...
        self.assertEqual(res['data']['data']['timetree']['days'],[{'day': now.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': [{'task_finish_id': f'{(ri[0].id-1)*3+3}', 'finish_time': tfw3.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': 'c'}, {'task_finish_id': f'{(ri[0].id-1)*3+2}', 'finish_time': tfw2.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': 'b'}, {'task_finish_id': f'{(ri[0].id-1)*3+1}', 'finish_time': tfw1.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': 'a'}]}, {'day': d6.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d5.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d4.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d3.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d2.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d1.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}],'error')

    # コメントなしtimetreeaftertobeforeのテスト
    def test_timetree_aftertobefore_post(self):
        u = User(
            username          = 'ヤマダ',
            email             = '1',
            age               = 19,
        ...
        d0 = post + timedelta(days=7)
        d1 = post + timedelta(days=6)
        d2 = post + timedelta(days=5)
        d3 = post + timedelta(days=4)
        d4 = post + timedelta(days=3)
        d5 = post + timedelta(days=2)
        d6 = post + timedelta(days=1)
        d7 = post - timedelta(days=1)
        d8 = post - timedelta(days=2)
        d9 = post - timedelta(days=3)
        d10 = post - timedelta(days=4)
        d11 = post - timedelta(days=5)

        self.assertEqual(res['data']['data']['timetree']['days'],[{'day': d0.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d1.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d2.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d3.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d4.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d5.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d6.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': post.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d7.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d8.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d9.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d10.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d11.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': now.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': [{'task_finish_id': f'{(ri[0].id-1)*3+3}', 'finish_time': tfw3.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+2}', 'finish_time': tfw2.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+1}', 'finish_time': tfw1.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}]}],'error')

    # コメントありtimetreeaftertobeforeのテスト
    def test_timetree_aftertobefore_with_comment_post(self):
        u = User(
            username          = 'ヤマダ',
            email             = '1',
            age               = 19,
    ...
    # コメントなしtimetreeaftertobeforeのテスト
    def test_timetree_aftertobefore_pre(self):
        u = User(
            username          = 'ヤマダ',
            email             = '1',
            age               = 19,
        ...
        d1 = pre + timedelta(days=6)
        d2 = pre + timedelta(days=5)
        d3 = pre + timedelta(days=4)
        d4 = pre + timedelta(days=3)
        d5 = pre + timedelta(days=2)
        d6 = pre + timedelta(days=1)
        d7 = pre - timedelta(days=1)
        d8 = pre - timedelta(days=2)
        d9 = pre - timedelta(days=3)
        d10 = pre - timedelta(days=4)
        d11 = pre - timedelta(days=5)
        d12 = pre - timedelta(days=6)

        self.assertEqual(res['data']['data']['timetree']['days'],[{'day': now.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': [{'task_finish_id': f'{(ri[0].id-1)*3+3}', 'finish_time': tfw3.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+2}', 'finish_time': tfw2.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}, {'task_finish_id': f'{(ri[0].id-1)*3+1}', 'finish_time': tfw1.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': None}]}, {'day': d1.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d2.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d3.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d4.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d5.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d6.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': pre.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d7.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d8.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d9.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d10.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d11.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d12.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}],'error')

    # コメントありtimetreeaftertobeforeのテスト
    def test_timetree_aftertobefore_with_comment_pre(self):
        u = User(
            username          = 'ヤマダ',
            email             = '1',
            age               = 19,
        ...
        self.assertEqual(res['data']['data']['timetree']['days'],[{'day': now.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': [{'task_finish_id': f'{(ri[0].id-1)*3+3}', 'finish_time': tfw3.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': 'c'}, {'task_finish_id': f'{(ri[0].id-1)*3+2}', 'finish_time': tfw2.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': 'b'}, {'task_finish_id': f'{(ri[0].id-1)*3+1}', 'finish_time': tfw1.strftime("%Y%m%dT%H%M%S%z"), 'done_time': 100, 'comment': 'a'}]}, {'day': d1.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d2.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d3.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d4.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d5.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d6.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': pre.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d7.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d8.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d9.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d10.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d11.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}, {'day': d12.strftime("%Y%m%dT%H%M%S%z")+'+0000', 'tasks': []}],'error')
