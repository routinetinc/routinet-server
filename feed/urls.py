...
urlpatterns = [
    ...
    path('sns/profile/follows/', views.Follow_related.as_view()),
    path('sns/list/user/follow/', views.Follow_related.as_view()),
    path('sns/list/user/follower/', views.Follower_related.as_view()),
